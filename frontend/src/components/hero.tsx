    ...
    <>
      <section className="relative w-full mb-48 " id="hero">
            ...
            <g clipPath="url(#clip0_17_60)">
              <g filter="url(#filter0_f_17_60)">
                <path
                  ...
                  fill="rgba(117, 83, 172, 0.5)"
                ></path>
                <path
                  d="M400 0H128.6L332.5 211.5L400 78.75V0Z"
                  fill="rgba(117, 83, 172, 0.6)"
                ></path>
                <path
                  d="M200 0H256.6L332.5 211.5L400 200.75V0Z"
          ...
          <div className="items-center relative max-w-7xl mx-auto w-full lg:px-16 md:px-12 lg:pb-24 lg:pt-30 pb-12 pt-28 px-5">
            <div className="max-w-5xl mx-auto">
              <div className="md:text-center text-left">
                <motion.div
                  className="max-w-4xl gap-6 lg:gap-12 lg:items-end mx-auto"
                  initial={{ opacity: 0 }}
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-[60%] flex justify-center items-center flex-wrap"></div>
        </div>
        <svg
          data-theme="dark"
